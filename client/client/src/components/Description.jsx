...
const Description = () => {
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        ...
        <p className='text-gray mb-8'>Turn your imagination into visuals</p>
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            images with just a few clicks. Imagine it, describe it, and watch 
            it come to life instantly.</p>
            <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge AI 
                ...
                product visuals to character designs and portraits,
                 ...
                 Powered by advanced AI technologyndthe creative possibilities are 
                 limitless!</p>
                 </div>
        </div>
    </div>
